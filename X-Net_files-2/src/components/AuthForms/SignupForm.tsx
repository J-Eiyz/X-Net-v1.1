      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            ...
            className="bg-gray-800 border border-gray-700 text-white sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5"
      ...
      <div className="flex items-start">
        <div className="flex items-center h-5">
          <input
            ...
            type="checkbox"
            className="w-4 h-4 border border-gray-700 rounded bg-gray-800 focus:ring-3 focus:ring-blue-500"
            required
          />
        </div>
        <div className="ml-3 text-sm">
          <label htmlFor="terms" className="text-gray-400">
            I accept the <a className="text-blue-500 hover:underline" href="#">Terms and Conditions</a>
          </label>
        </div>
      </div>
